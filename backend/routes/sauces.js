...
const inputVal = require('../middleware/input-val');

router.post('/', auth,inputVal, multer, sauceCtrl.createSauce); // création d'une route pour créer un nouvelle sauce
router.put('/:id', auth, inputVal, multer, sauceCtrl.modifySauce); // création d'une route pour modifier un sauce
